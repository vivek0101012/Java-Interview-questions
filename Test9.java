...
//  decides what methods are accessible during the compile time it self -> it is called compile time bidning or early binding or static binding

// during the run time , the run time object decides which variation of the allowed method will be exactly executed--> run time binding / dynamic dispatch mechanism. 

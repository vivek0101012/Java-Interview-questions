...
//ans> for non static methdos the  reference varaible 
//  decides what methods are accescible during the compile time it self > it is called compile time bidning or early binding

// during the run time , the run time object decides which variation of the method will eb exactly executed> run time binding / dynamic dispatch mechanism. 

//Note > variables are always resolved using the reference variables 
